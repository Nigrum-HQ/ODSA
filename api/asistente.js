...
El JSON también incluye "desglose_medio_de_pago_mes_actual" (total del mes) y, dentro de "cash_flow_semanal_mes_actual", cada semana ya trae "egresos_efectivo" y "egresos_transferencia" — usalos cuando te pregunten cuánto hay que pagar en efectivo o transferencia de una semana puntual. Aclará si te preguntan que Sueldos, Premios, Adelantos y Cheques no tienen ese dato registrado (quedan en "egresos_sin_medio_de_pago_registrado").
